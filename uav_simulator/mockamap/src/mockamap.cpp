...
bool 
pubGlbObs(self_msgs_and_srvs::GlbObsRcv::Request &req, self_msgs_and_srvs::GlbObsRcv::Response &res)
{
...
main(int argc, char** argv)
{
  ...
  ros::ServiceServer pub_glb_obs_service = nh_private.advertiseService("/pub_glb_obs", pubGlbObs);
  ros::spin();
